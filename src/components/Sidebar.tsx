...
export type View = 'projects' | 'objectives' | 'overview' | 'keywords' | 'lost-keywords' | 'seo-audit' | 'content-audit' | 'aeo-audit' | 'schema-audit' | 'advertising' | 'recommendations' | 'activity-log';
