...
export default function PricingPage({ onOpenApp }: { onOpenApp: () => void }) {
  ...
  return (
    <WebsiteLayout
      onOpenApp={onOpenApp}
      title="Pricing — Base, Plus & Managed Digital Plans | SEAUTO"
      description="Base plan at $10/project/month with 1 project, 5 audits, and 50 keyword scans. Plus is $30/project/month. Managed Digital at $200/project/month includes the AI execution bot and full advertising suite."
    >
      <section className="pt-16 pb-8 lg:pt-24 lg:pb-12 relative overflow-hidden">
        ...
        <div className="relative max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-[#6E6E73] leading-relaxed">
            Per-project pricing so you only pay for what you use. No contracts, no hidden fees, cancel anytime.
          </p>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 flex flex-col">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                {[
                  ...
                  { text: '5 page audits / month', ok: true, note: 'SEO & Content audits only' },
                  { text: 'Keyword tracking', ok: true },
            ...
            <div className="relative bg-[#1D1D1F] text-white rounded-2xl p-8 ring-2 ring-[#0071E3] shadow-2xl scale-[1.02] lg:scale-105 flex flex-col">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                {[
                  ...
                  { text: '50 page audits / month', ok: true, note: 'All 6 audit types including full site audit' },
                  { text: 'Keyword tracking', ok: true },
                  { text: 'Daily keyword refresh', ok: true },
                  { text: '100 keyword scans / month', ok: true },
                  { text: 'Keyword recommendations', ok: true },
                  { text: '30 blog posts / month', ok: true },
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200 flex flex-col">
              ...
              <ul className="space-y-3 mb-8 flex-1">
                {[
                  { text: 'Unlimited projects', ok: true },
                  { text: 'Unlimited page audits', ok: true, note: 'All 6 audit types' },
                  { text: 'Keyword tracking', ok: true },
                  { text: 'Real-time keyword refresh', ok: true },
                  { text: '200 keyword scans / month', ok: true },
                  { text: 'Keyword recommendations', ok: true },
                  { text: '100 blog posts / month', ok: true },
                  { text: '30 page builds / month', ok: true },
                  { text: 'Full site audit', ok: true },
      ...
      <section className="py-20 bg-[#FAFAFA]">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="space-y-3">
            {[
              { q: 'What does "per project" mean?', a: 'Each website you manage in SEAUTO is a project. If you manage 3 client websites, that\'s 3 projects. The Base plan includes 1 project. Plus and Managed Digital support unlimited projects — add as many as you need.' },
              ...
              { q: 'What\'s the difference between Base and Plus?', a: 'Base ($10/project/month) gives you 1 project with SEO & Content audits, 50 keyword scans, and 5 blog posts. Plus ($30/project/month) unlocks unlimited projects, all 6 audit types, 100 keyword scans, 30 blog posts, and full site audits.' },
      ...
      <InternalLinks links={[
        { to: '/features/seo-audit-tool', label: 'SEO Audit Tool', desc: 'Base includes SEO & Content audits. Plus and Managed Digital unlock all 6 audit types.' },
        { to: '/features/keyword-rank-tracker', label: 'Keyword Rank Tracker', desc: 'Keyword tracking included on all plans. Plus and Managed Digital offer daily and real-time refresh.' },
        ...
        { to: '/solutions/small-business-seo', label: 'Small Business SEO', desc: 'Start with the Base plan, upgrade when your business grows.' },
